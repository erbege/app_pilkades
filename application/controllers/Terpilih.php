...
class Terpilih extends AUTH_Controller {
	public function __construct() {
		parent::__construct();
		$this->load->model('M_penyelenggara','desapemilihan');
		$this->load->model('M_terpilih','terpilih');
	}
	...
	public function index() {
		...
		if ($this->input->post('nama_kec')) {
			$data['dataterpilih'] 	= $this->terpilih->select_by_kec($this->input->post('nama_kec'));
		} else {
			$data['dataterpilih'] 	= $this->terpilih->select_all();
		}
		...
		$data['page'] 			= "terpilih";
		$data['judul'] 			= "Daftar Calon Terpilih";
		$data['deskripsi'] 		= "";
		
		$this->template->views('terpilih/home', $data);
	}
